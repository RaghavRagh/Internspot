...
const SubscriptionInfo = ({
  ...
  return (
    <div className="flex flex-col max-w-lg p-3 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow xl:p-3 sm:min-w-72 hover:shadow-lg transition ease-out">
      ...
      <button
        className="focus:ring-2 focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center border border-slate-300 hover:bg-gray-100/60 transition ease-linear shadow"
